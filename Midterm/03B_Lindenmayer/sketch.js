...
var thestring = 'FX'; // "axiom" or start of the string
var numloops = 12; // how many iterations of the L-system to pre-compute
var therules = []; // array for rules
therules[0] = ['X', 'X+YF+']; // first rule
therules[1] = ['Y', '-FX-Y']; // second rule
...
function setup()
{
  createCanvas(2000, 2000); // this is the size of the window
